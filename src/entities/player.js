...
export class Player {
  ...
  // Play the attack animation on demand (manual touch attack). The animation
  // state machine in update() preserves an unfinished attack pose, so this
  // shows a visible swing/cast that plays through before reverting.
  triggerAttackAnim() {
    if (this.dead) return;
    this.state = 'attack';
